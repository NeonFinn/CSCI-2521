...
void arraySolution()
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        // when valid put the score in the array
        scores[i] = score;
    }
...
void vectorSolution()
{
    ...
    while (true)
    {
        ...
        // when valid push the score into the vector
        scores.push_back(score);
    }

    // if no score was entered and the user inputs -1 to quit
    if (scores.size() == 0)
    {
